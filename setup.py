...
setup(
    name='Diamond_Price_Prediction',  # Specify the name of the package
    version='0.0.1',  # Specify the version of the package
    author='Swagata Banerjee',  # Specify the author of the package
    author_email='banerjeeswagata19@gmail.com',  # Specify the author's email
